...
- `scripts/train.py` is used to train DGOT using a given configs.

- `scripts/evaluation.py` is used to evaluate DGOT on imbalanced data by using a evaluation model.
